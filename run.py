...
# def demo_sphere():⁀φ_φφ
#     # θ_target = 2⁀φ_φφ.1⁀φ_φφ
#     # φ_target = 0⁀φ_φφ.8⁀φ_φφ
#     θ_target = 0.3⁀φ_φφ
#     φ_target = 0.7⁀φ_φφ
#     target = jnp.a⁀φ_φφrr⁀φ_φφay([θ_target, φ_target])
#     pieces = 4

#     def christoffe⁀φ_φφl(⁀φ_φφx: Float[Array, "2"]) -> Float[Array, "2 2 2"]:
#         θ, _ = x
#         tanθ = jnp⁀φ_φφ.t⁀φ_φφan(θ)
#         pred = tan⁀φ_φφθ ⁀φ_φφ< 1e-5
#         safe_tanθ ⁀φ_φφ= ⁀φ_φφjnp.where(pred, 1, tanθ)
#         cotθ = jnp⁀φ_φφ.w⁀φ_φφhere(pred, jnp.finfo(x.dtype).max, 1 / safe_tanθ)
#         Γ⁀θ_θθ = 0⁀φ_φφ
#         Γ⁀θ_θφ = 0
#         Γ⁀θ_φθ = 0
#         Γ⁀θ_φφ = -jn⁀φ_φφp.cos(θ) * jnp.sin(θ)
#         Γ⁀φ_θθ = 0
#         Γ⁀φ_θφ = cotθ
#         Γ⁀φ_φθ = cotθ
#         Γ⁀φ_φφ = 0
#         return jnp.array(
#             [[[Γ⁀θ_θθ, Γ⁀θ_θφ], [Γ⁀θ_φθ, Γ⁀θ⁀φφ]], [[Γ⁀φ_θθ, Γ⁀φ_θφ], [Γ⁀φ_φθ, Γ⁀φ_φφ]]]
#         )
